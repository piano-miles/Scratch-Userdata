...
print('The program is now ready for data collection. Note, this will use a large amount of memory, so make sure you have at least 4GB available.')
print('Proceed to collect data? (y/n)')
...
if not 'n' in input().lower():
    ...
    f = open('data/webdata.csv', 'w')
    f.write(data)
    f.close()
    print('File written to webdata.csv.\nDownloading Data.')
